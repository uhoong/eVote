...
contract('eVote', async (accounts) => {
    ...
    it('Malicious Administrator', async () => {
        ...
        //dispute case 1
        proof2 = computationMerkleTree.getHexProof(keccak256(computationArray[0]))
        t1 = [0, 0, 0]
        ...
        //dispute case 2        
        proof1 = computationMerkleTree.getHexProof(keccak256(computationArray[1]))
        proof2 = computationMerkleTree.getHexProof(keccak256(computationArray[2]))
        ...
        //dispute case 3
        proof2 = computationMerkleTree.getHexProof(keccak256(computationArray[data.length - 1]))
        t1 = [0, 0, 0]
    ...
    it('Honest Administrator', async () => {
        ...
        finishTally = (await eVoteInstance.finishTallyBlockNumber.call()).toNumber()
